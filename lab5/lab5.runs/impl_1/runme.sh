...
HD_PWD='C:/Users/ayber/lab5/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ortakmodule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ortakmodule.tcl -notrace
