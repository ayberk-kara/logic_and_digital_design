...
HD_PWD='C:/Users/ayber/lab5/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ortakmodule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ortakmodule.tcl
